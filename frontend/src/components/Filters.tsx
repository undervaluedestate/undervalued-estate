  ...
  return (
    <div>
      ...
      <div className="actions">
        ...
        <button className="button secondary" onClick={()=>onChange({ ...value, q:'', country:'', state:'', city:'', neighborhood:'', property_type:'', min_price:'', max_price:'', min_size_sqm:'', max_size_sqm:'', min_pct_below:'', deal_type:'', } as FiltersValue)}>Reset</button>
      </div>
    </div>
  );
}
